...
import rus.iglo.okno.Gui4ButtonMessage;
...
public class Gui4Screen extends AbstractContainerScreen<Gui4Menu> {
	private final static HashMap<String, Object> guistate = Gui4Menu.guistate;
	...
	public Gui4Screen(Gui4Menu container, Inventory inventory, Component text) {
	...
	public void init() {
		...
		imagebutton_knopka = new ImageButton(this.leftPos + -110, this.topPos + 52, 185, 25, 0, 0, 25, new ResourceLocation("dialog_okno:textures/screens/atlas/imagebutton_knopka.png"), 185, 50, e -> {
			if (true) {
				DialogOknoMod.PACKET_HANDLER.sendToServer(new Gui4ButtonMessage(0, x, y, z));
				Gui4ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_knopka1 = new ImageButton(this.leftPos + -110, this.topPos + 97, 185, 25, 0, 0, 25, new ResourceLocation("dialog_okno:textures/screens/atlas/imagebutton_knopka1.png"), 185, 50, e -> {
			if (true) {
				DialogOknoMod.PACKET_HANDLER.sendToServer(new Gui4ButtonMessage(1, x, y, z));
				Gui4ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
